...
find ~/sarnobat.git/mwk/snippets/ -maxdepth 1 -type f | mvn exec:java  --settings ~/sarnobat.git/mac/.m2/settings.xml -Dexec.mainClass="com.technobium.MahoutTermFinderMwkSnptRefactoredCluster" -Ddebug=true -Ddocs=40
