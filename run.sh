...
find ~/sarnobat.git/mwk/snippets/ -maxdepth 2 -type f | head -320 | mvn exec:java  --settings ~/sarnobat.git/mac/.m2/settings.xml -Dexec.mainClass="com.technobium.MahoutTermFinderMwkSnptRefactoredCluster" -Ddebug=false -Dthreshold=2.5 -DshowTerms=true | tee ../report_snpts.txt